...
@ActiveProfiles("test")
class InternalVwEudaControllerTest {

    private static final String TOKEN_HEADER = "X-Internal-Token";
    private static final String VALID_TOKEN = "test-internal-token";

    @Autowired MockMvc mockMvc;
    @MockitoBean VwEudaImportService importService;
    @MockitoBean VwEudaNotificationService notifications;
    @MockitoBean VwEudaAutoSyncEntitlementService entitlement;
    ...
    void entitlement_returnsCoreDecision() throws Exception {
        ...
        when(entitlement.entitlementFor(user)).thenReturn(
                new VwEudaAutoSyncEntitlementService.Entitlement(true, true, java.time.LocalDate.of(2026, 10, 21)));
    ...
    void import_unreadableFile_returns422() throws Exception {
        ...
        when(importService.importData(any(), any(), any(InputStreamSource.class), anyString(), any(), anyBoolean()))
                .thenThrow(new com.evmonitor.application.imports.vweuda.VwEudaUnreadableException(
