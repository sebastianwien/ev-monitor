 ...
 */
class VwEudaAutoSyncEntitlementServiceTest {
    ...
    private final VwEudaAutoSyncEntitlementService service = new VwEudaAutoSyncEntitlementService(properties(30));

    private static VwEudaAutoSyncTrialProperties properties(int days) {
        VwEudaAutoSyncTrialProperties p = new VwEudaAutoSyncTrialProperties();
    ...
    void trialLengthIsConfigurable() {
        var twoWeeks = new VwEudaAutoSyncEntitlementService(properties(14));
