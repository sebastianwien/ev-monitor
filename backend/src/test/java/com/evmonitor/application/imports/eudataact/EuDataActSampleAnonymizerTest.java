...
class EuDataActSampleAnonymizerTest {

    private final ObjectMapper mapper = new ObjectMapper();
    private final EuDataActSampleAnonymizer anonymizer = new EuDataActSampleAnonymizer(mapper);
    private final EUDataActJsonParser parser = new EUDataActJsonParser(mapper);
    ...
    private void assertSameSessions(byte[] original) throws IOException {
        ...
        EUDataActParseResult before = parser.parse(new ByteArrayResource(original), false);
        EUDataActParseResult after = parser.parse(new ByteArrayResource(anonymized), false);
