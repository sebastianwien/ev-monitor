...
class EudaLoginClientTest {
    ...
    private EudaLoginClient client;
    ...
    void setUp() throws IOException {
        ...
        client = new EudaLoginClient(http, "skoda");
    ...
    void login_happyPath_walksRecordedFlowAndExportsOnlySsoCookies() {
        ...
        List<EudaHttp.Request> r = http.requests;
        ...
        EudaHttp.Request identifierPost = r.get(3);
        ...
        EudaHttp.Request passwordPost = r.get(5);
    ...
    void login_neverSendsPasswordAnywhereButThePasswordPost() {
        ...
        for (int i = 0; i < http.requests.size(); i++) {
            if (i == 5) continue;
            EudaHttp.Request req = http.requests.get(i);
    ...
    void login_wrongPassword_throwsInvalidCredentials() {
        ...
        assertThrows(EudaAuthException.InvalidCredentials.class, () -> client.login("user@example.com", "wrong"));
    }
    ...
    void login_termsInterstitial_throwsInteractionRequired() {
        ...
        EudaAuthException.InteractionRequired ex = assertThrows(EudaAuthException.InteractionRequired.class,
    ...
    void login_idpDown_throwsPortalUnavailable() {
        ...
        assertThrows(EudaAuthException.PortalUnavailable.class, () -> client.login("user@example.com", "pw"));
    }

    @Test
    void unknownBrand_isRejectedBeforeAnyRequest() {
        assertThrows(IllegalArgumentException.class, () -> new EudaLoginClient(http, "tesla"));
    ...
    private static Map<String, String> form(EudaHttp.Request req) {
    ...
    static class ScriptedHttp implements EudaHttp {
