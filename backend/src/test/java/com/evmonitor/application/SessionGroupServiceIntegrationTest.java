...
class SessionGroupServiceIntegrationTest extends AbstractIntegrationTest {
    ...
    @Test
    void processWallboxLog_firstGoeSession_createsNewGroup() {
        EvLog log = createAndSaveGoeLog(testCar.getId(), "5.0", LocalDateTime.now().minusHours(3));

        sessionGroupService.processWallboxLog(log);
    ...
    @Test
    void processWallboxLog_secondSessionWithinMergeGap_extendsExistingGroup() {
        ...
        sessionGroupService.processWallboxLog(log1);
        sessionGroupService.processWallboxLog(log2);
    ...
    @Test
    void processWallboxLog_sessionOutsideMergeGap_createsNewGroup() {
        LocalDateTime session1Start = LocalDateTime.now().minusHours(5);
    ...
    @Test
    void processWallboxLog_sessionNextDay_createsNewGroup() {
    ...
    void getSubSessions_returnsAllSubSessionsForGroup() {
        ...
        sessionGroupService.processWallboxLog(log1);
        sessionGroupService.processWallboxLog(log2);
        sessionGroupService.processWallboxLog(log3);
    ...
    @Test
    void processWallboxLog_customMergeGap_respectsConfiguredThreshold() {
        ...
        sessionGroupService.processWallboxLog(log1, 15);
        sessionGroupService.processWallboxLog(log2, 15);
    ...
    @Test
    void processWallboxLog_multipleSubSessions_aggregatesKwhAndCost() {
