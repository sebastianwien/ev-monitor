...
public enum CarBrand {
   ...
   public enum CarModel {
      ...
      KONA_ELECTRIC(CarBrand.HYUNDAI, VehicleCategory.COMPACT, "Kona Electric",
            ...
            cap(64.8),
            cap(65.4)),
      INSTER(CarBrand.HYUNDAI, VehicleCategory.CITY_CAR, "Inster",
            cap(39.0, "Standard Range"),
            cap(46.0, "Long Range")),
      IONIQ_9(CarBrand.HYUNDAI, VehicleCategory.LARGE_SUV, "Ioniq 9",
            cap(107.0)),
      IONIQ_5_N(CarBrand.HYUNDAI, VehicleCategory.SUV, "Ioniq 5 N",
            cap(80.0)),
      IONIQ_6_N(CarBrand.HYUNDAI, VehicleCategory.SEDAN, "Ioniq 6 N",
            cap(80.0)),
      ...
      EV_5(CarBrand.KIA, VehicleCategory.SUV, "EV5",
            cap(81.4)),
      PV_5(CarBrand.KIA, VehicleCategory.VAN, "PV5",
            cap(51.5),
            cap(71.2)),
      ...
      POLESTAR_4(CarBrand.POLESTAR, VehicleCategory.SUV, "Polestar 4",
            cap(94.0)),
      // Volvo: battery_capacity_kwh = Brutto (Netto in vehicle_specification). WLTP-Werte via ADAC verifiziert.
      EX_30(CarBrand.VOLVO, VehicleCategory.COMPACT, "EX30",
            cap(51.0, "Single Motor"),
            cap(69.0, "Extended Range")),
      EX_30_CROSS_COUNTRY(CarBrand.VOLVO, VehicleCategory.COMPACT, "EX30 Cross Country",
            cap(69.0, "Twin Motor Performance")),
      EX_40(CarBrand.VOLVO, VehicleCategory.SUV, "EX40",
            cap(70.0, "Single Motor"),
            cap(82.0, "Extended Range")),
      EC_40(CarBrand.VOLVO, VehicleCategory.SUV, "EC40",
            cap(70.0, "Single Motor"),
            cap(82.0, "Extended Range")),
      // Legacy-Namen (2020-2024, vor dem Rename zu EX40/EC40). Eigene Batterie-Historie inkl. 78-kWh-Twin.
      XC_40_RECHARGE(CarBrand.VOLVO, VehicleCategory.SUV, "XC40 Recharge",
            cap(69.0, "Single Motor"),
            cap(78.0, "Twin Motor"),
            cap(82.0, "Extended Range")),
      C_40_RECHARGE(CarBrand.VOLVO, VehicleCategory.SUV, "C40 Recharge",
            cap(69.0, "Single Motor"),
            cap(78.0, "Twin Motor"),
            cap(82.0, "Extended Range")),
      EX_90(CarBrand.VOLVO, VehicleCategory.LARGE_SUV, "EX90",
            cap(104.0, "Single Motor"),
            cap(111.0, "Twin Motor")),
      ES_90(CarBrand.VOLVO, VehicleCategory.SEDAN, "ES90",
            cap(92.0, "Single Motor Extended Range"),
            cap(106.0, "Twin Motor")),
      ...
      MOKKA_E(CarBrand.OPEL, VehicleCategory.COMPACT, "Mokka-e",
            cap(50.0),
            cap(54.0)),
      GRANDLAND(CarBrand.OPEL, VehicleCategory.SUV, "Grandland Electric",
            cap(77.0),
            cap(98.0, "Long Range")),
      FRONTERA(CarBrand.OPEL, VehicleCategory.SUV, "Frontera Electric",
            cap(44.0),
            cap(54.0, "Extended Range")),
