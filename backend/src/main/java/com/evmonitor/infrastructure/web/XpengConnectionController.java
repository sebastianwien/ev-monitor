...
public class XpengConnectionController {
    ...
    public ResponseEntity<?> grant(@AuthenticationPrincipal UserPrincipal principal,
                                   @org.springframework.web.bind.annotation.RequestBody GrantRequest req,
        ...
        try {
            ...
            XpengConnection conn = service.grantConsent(userId, req.carId(), normalizeVin(req.vin()), ip, userAgent);
    ...
    public record GrantRequest(
            ...
            @NotNull @Size(min = 17, max = 17) @Pattern(regexp = "[A-HJ-NPR-Z0-9]{17}",
                    message = "VIN muss 17 gültige Zeichen haben") String vin,
