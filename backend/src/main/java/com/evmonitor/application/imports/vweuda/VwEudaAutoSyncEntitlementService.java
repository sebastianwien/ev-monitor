 ...
 * Trial ({@link VwEudaAutoSyncTrialProperties}) - alle anderen. SUPPORTER zahlt nur fuer
 * Auswertungen und bekommt keinen AutoSync.
 */
@Service
@RequiredArgsConstructor
public class VwEudaAutoSyncEntitlementService {

    private final VwEudaAutoSyncTrialProperties trial;
