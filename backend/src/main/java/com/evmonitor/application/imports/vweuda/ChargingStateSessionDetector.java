...
class ChargingStateSessionDetector implements SessionDetector {
    ...
    @Override
    public List<VwEudaSession> detect(EntryIndex index) {
        List<VwEudaSession> sessions = new ArrayList<>();
        ...
        return sessions.stream()
                .sorted(Comparator.comparing(VwEudaSession::startedAt))
                .toList();
    }

    private VwEudaSession buildSession(OffsetDateTime start, OffsetDateTime end, EntryIndex index) {
