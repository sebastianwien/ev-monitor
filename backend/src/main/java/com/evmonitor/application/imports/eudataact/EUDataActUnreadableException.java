 ...
 */
public class EUDataActUnreadableException extends IllegalArgumentException {

    public EUDataActUnreadableException(String message) {
        super(message);
    }

    public EUDataActUnreadableException(String message, Throwable cause) {
        super(message, cause);
    }
}
