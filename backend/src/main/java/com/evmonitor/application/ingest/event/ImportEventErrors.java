 ...
 * der Datei (Jackson) oder Zahlen. Alles nach dem ersten Doppelpunkt, alles in Anführungszeichen oder
 * Klammern und alle Ziffern fliegen raus - das hält Inhalte fern und gruppiert gleiche Fehler gleich.
 */
