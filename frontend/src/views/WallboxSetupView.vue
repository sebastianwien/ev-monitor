...
<template>
  <div class="max-w-2xl mx-auto px-4 py-8">
    ...
    <!-- Beta Disclaimer -->
    <div class="flex items-start gap-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-sm p-4 mb-8">
    ...
    <!-- Alerts -->
    <div v-if="success" class="flex items-start gap-2 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-sm p-4 mb-6">
    ...
    <div v-if="error" class="flex items-start gap-2 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-sm p-4 mb-6">
    ...
    <template v-else>
      ...
      <div v-if="connections.length > 0" class="mb-8 space-y-3">
        ...
        <div
          ...
          :key="conn.id"
          class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-sm overflow-hidden"
        >
          <!-- Connection header -->
            ...
            <div v-else class="space-y-2">
              <div class="relative">
                <input
                  ...
                  class="w-full border border-gray-300 dark:border-gray-600 rounded-sm px-3 py-1.5 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500"
                />
                <ul v-if="getEditState(conn.id).locationResults.length > 0"
                  class="absolute z-10 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-sm shadow-[4px_4px_0_rgba(0,0,0,0.30)] dark:shadow-[4px_4px_0_rgba(255,255,255,0.30)] mt-1 max-h-48 overflow-auto">
              ...
              <div class="flex items-center gap-2">
                <button @click="saveLocation(conn)" :disabled="getEditState(conn.id).saving"
                  class="flex items-center gap-1 text-xs bg-green-600 text-white px-3 py-1.5 rounded-sm hover:bg-green-700 disabled:opacity-50">
          ...
          <div class="border-t border-gray-100 dark:border-gray-700 px-4 py-3">
            ...
            <div v-else class="flex items-center gap-2">
              <input
                ...
                class="flex-1 border border-gray-300 dark:border-gray-600 rounded-sm px-2 py-1 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500"
      ...
      <div v-if="!showForm" class="mb-8">
        <button
          ...
          class="flex items-center gap-2 bg-green-600 text-white px-5 py-2.5 rounded-sm font-medium hover:bg-green-700 transition"
        >
      ...
      <div v-else class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-sm p-6 mb-8 space-y-5">
        ...
        <div>
          ...
          <input
            ...
            class="w-full border border-gray-300 dark:border-gray-600 rounded-sm px-3 py-2 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500"
          />
        ...
        <!-- OCPP URL Preview -->
        <div v-if="formChargePointId.trim()" class="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-sm p-4">
        ...
        <div class="flex gap-3 pt-2">
          <button
            @click="save"
            :disabled="saving"
            class="bg-green-600 text-white px-5 py-2 rounded-sm text-sm font-medium hover:bg-green-700 transition disabled:opacity-50"
          >
            {{ saving ? t('wallbox.save_btn_loading') : t('wallbox.save_btn') }}
          </button>
          <button
            @click="showForm = false; error = null"
            class="text-gray-600 dark:text-gray-300 px-5 py-2 rounded-sm text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition"
          >
