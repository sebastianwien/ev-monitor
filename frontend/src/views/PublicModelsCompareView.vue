            ...
            <div :class="validModels.length === 3 ? 'grid grid-cols-3 gap-3' : 'grid grid-cols-2 gap-3'">
              <div v-for="(m, mi) in validModels" :key="m.brand + m.model" class="text-center">
                ...
                <select
                  ...
                  <option v-for="(v, vi) in m.wltpVariants" :key="vi" :value="vi">{{ v.batteryCapacityKwh }} kWh{{ v.realConsumptionTripCount ? ` (${v.realConsumptionTripCount} Fahrten)` : '' }}</option>
                </select>
              </div>
            </div>
          </div>
                    ...
                    <div v-if="m.wltpVariants.length > 1" class="mt-2">
                      <select
                        ...
                        <option v-for="(v, vi) in m.wltpVariants" :key="vi" :value="vi">
                          {{ v.batteryCapacityKwh }} kWh{{ v.realConsumptionTripCount ? ` (${v.realConsumptionTripCount} Fahrten)` : '' }}
                        </option>
                      </select>
                    </div>
                  </th>
