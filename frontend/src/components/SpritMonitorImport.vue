      ...
      <div class="p-6">
        ...
        <div v-if="importStep === 'token'">
          ...
          <button
            @click="fetchVehicles"
            :disabled="loading"
            class="w-full px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2">
