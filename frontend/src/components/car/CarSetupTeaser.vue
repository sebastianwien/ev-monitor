 ...
 *
 * Beide Varianten teilen sich denselben Indigo-Akzent; sie unterscheiden sich nur
...
<template>
  <div class="relative flex items-start gap-2.5 border-b-2 border-gray-300 dark:border-gray-600 bg-indigo-50 dark:bg-indigo-900/20 px-4 py-3 pr-10">
    <component
    ...
    <div class="min-w-0 flex-1">
      ...
      <button
        ...
        type="button"
        v-haptic
        class="mt-1.5 text-xs font-semibold text-indigo-700 dark:text-indigo-300 underline decoration-dotted hover:decoration-solid"
        @click="onAction"
      >
      ...
      <router-link
        v-else
        to="/upgrade"
        class="mt-1.5 inline-block text-xs font-semibold text-indigo-700 dark:text-indigo-300 underline decoration-dotted hover:decoration-solid"
        @click="onAction"
      >
