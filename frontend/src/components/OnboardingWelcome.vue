    ...
    <Transition
      ...
      <div
        ...
        <Transition
          ...
          <div v-if="showWelcome" class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full relative max-h-[90dvh] overflow-y-auto">
              ...
              <Transition :name="direction === 'forward' ? 'slide-forward' : 'slide-backward'" mode="out-in">
                ...
                <div v-if="step === 1" key="1" class="h-[480px] flex flex-col px-8 pb-8 text-center">
                  ...
                  <div class="flex flex-col items-center gap-2">
                    ...
                    <p class="text-xs text-gray-400">Du kannst das Tutorial jederzeit überspringen</p>
                  </div>
                </div>
                ...
                <div v-else-if="step === 2" key="2" class="h-[480px] flex flex-col px-8 pb-8 text-center">
                  <div class="flex-1 flex flex-col items-center justify-center gap-4">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4 text-left max-w-md mx-auto w-full">
                      <ul class="text-sm text-blue-800 space-y-0.5">
                  ...
                  <div class="flex gap-4 justify-center">
                    <button @click="back" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">← Zurück</button>
                    ...
                    <div class="grid grid-cols-2 gap-3 w-full max-w-sm mx-auto">
                      ...
                      <div class="bg-gray-50 border border-gray-200 rounded-xl p-3 flex items-center gap-3">
                        ...
                        <div class="text-left">
                          ...
                          <p class="text-xs text-gray-600">Schnell & flexibel</p>
                        </div>
                      </div>
                    </div>
                    <div class="w-full">
                      <p class="text-xs text-gray-500 mb-1.5">Oder importiere bestehende Daten aus:</p>
                      <div class="flex flex-wrap justify-center gap-1.5">
                        <span class="text-xs bg-gray-100 text-gray-600 px-2.5 py-1 rounded-full">Sprit-Monitor</span>
                        <span class="text-xs bg-gray-100 text-gray-600 px-2.5 py-1 rounded-full">go-eCharger</span>
                        <span class="text-xs bg-gray-100 text-gray-600 px-2.5 py-1 rounded-full">Tesla / TeslaLogger</span>
                        <span class="text-xs bg-gray-100 text-gray-600 px-2.5 py-1 rounded-full">OCPP Wallbox</span>
                      </div>
                    </div>
                  </div>
                ...
                <div v-else-if="step === 4" key="4" class="h-[480px] flex flex-col px-4 sm:px-8 pb-4 sm:pb-8 text-center">
                  <div class="flex-1 flex flex-col items-center justify-center gap-3">
                    ...
                    <div v-if="isAlreadyInstalled" class="bg-green-50 border border-green-200 rounded-xl p-3 max-w-md mx-auto w-full">
                      <p class="text-sm text-green-800 font-medium">Bereits installiert! Du nutzt EV Monitor schon als App.</p>
                    </div>
                    ...
                    <template v-else>
                      ...
                      <div v-else-if="isIOS" class="bg-blue-50 border border-blue-200 rounded-xl p-3 text-left max-w-md mx-auto w-full">
                        <p class="font-semibold text-blue-900 text-sm mb-1.5">In Safari:</p>
                      ...
                      <div v-else-if="isAndroid" class="bg-blue-50 border border-blue-200 rounded-xl p-3 text-left max-w-md mx-auto w-full">
                        <p class="font-semibold text-blue-900 text-sm mb-1.5">In Chrome:</p>
                        <ol class="text-sm text-blue-800 space-y-1.5">
                      ...
                      <div v-else class="bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm text-gray-600 max-w-md mx-auto w-full">
