...
<template>
  <section
    class="rounded-sm border-2 border-amber-500 dark:border-amber-500 bg-white dark:bg-gray-800 p-5 md:p-6 shadow-[4px_4px_0_0_#f59e0b] dark:shadow-[4px_4px_0_0_#f59e0b]">
    <!-- Step badge + eyebrow -->
    ...
    <div class="flex flex-col sm:flex-row gap-3">
      <a :href="mailtoUrl" target="_blank" rel="noopener"
         class="inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 text-gray-950 font-bold uppercase tracking-wider text-xs px-5 py-3 rounded-sm border-2 border-amber-500 shadow-[3px_3px_0_0_#030712] active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-[transform,box-shadow] duration-75">
